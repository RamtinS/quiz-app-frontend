...
describe('Register page test', () => {
    ...
    it("Button should be activated when input fields are not empty", () => {
        generateTestData("Test", "test@test.com", "Test",
    ...
    it("Bad format on email should give error.", () => {
        generateTestData("Test", "testtest.com", "Test",
          "Test", "password", "password");
        cy.get('[data-cy="error-message"]').should("not.be.disabled");
    });

    function generateTestData(username: string, email: string, firstName: string,
                              surname: string, password: string, confirmPassword: string): void {
