...
const props = defineProps({
  preExistingQuestion: {
    type: Object as () => MultipleChoiceQuestionDTO,
    required: true,
  },
});
...
const inputAnswers = ref<
  Array<{ inputText: string; answerIsCorrect: boolean }>
>([]);
...
function submitQuestion() {
  ...
  const error =
    QuizValidationUtility.multipleChoiceQuestionIsValid(questionDTO);
...
<template>
  <div id="question-editor">
    <div id="answers">
      <div
        v-for="(question, index) in inputAnswers"
        :key="index"
        class="answer"
      >
        <textarea
    ...
    <div class="button-container">
      <button @click="addNewAnswer">Add new answer</button>
