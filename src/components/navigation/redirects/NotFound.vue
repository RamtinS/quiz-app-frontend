  ...
  <div>
    <div id="error-message">
      ...
      <img
        ...
        alt="detective looking for your page"
      />
      <p id="running-url">Your URL</p>
    </div>
  </div>
</template>
...
#detective {
  ...
  margin-left: auto;
  margin-right: auto;
  filter: drop-shadow(0 0 25px #fc0) drop-shadow(0 0 50px green);
  animation: search-around 10s ease-in-out infinite;
}
