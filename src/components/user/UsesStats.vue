...
const yAxisLabels = ref<Array<number>>([
...
/**
 * Fetches the user statistics when the component is mounted.
 */
onMounted(async () => {
  try {
    ...
    if (Object.keys(attemptsPerDayMap).length > 0) {
      ...
      xAxisLabels.value = dates.map(
        (dateString) => days[new Date(dateString).getDay()],
      );
    }
  ...
  <div class="user-progress">
    ...
    <div v-else class="grid-container">
      <div class="graph-container">
        <p class="graph-title">
          The amount of quizzes completed the last 7 days
        </p>
      ...
      <div class="stats-container" data-cy="stats-container">
        <div class="stats-item">
          ...
          <div class="stats-value" data-cy="total-attempts">
            {{ totalAttempts }}
          </div>
        </div>
